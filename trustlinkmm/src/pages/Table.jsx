...
export default function ViewTickets() {
    ...
    const userUnsolvedTickets = userTickets.slice(indexOfFirstTicket, indexOfLastTicket);

    const totalPages = Math.ceil( userSolvedTickets ? userSolvedTickets.length / ticketsPerPage : filteredTickets ? filteredTickets.length / ticketsPerPage : userTickets.length / ticketsPerPage);
                                ...
                                (async () => {
                                    try {
                                        ...
                                        if (res.status === 200) {
                                            ...
                                            console.error('Error filtering ticket:', data.error ? data.error.details : 'Unknown error');
                                            setHasError(true);
                    ...
                    <TableBody>
                        {/* { filteredTickets.length > 0 ? (
                            filteredTickets.map(filteredTicket => (
                                    <TableRow key={filteredTicket.id}>
                                ...
                                userTickets.map(userTicket => (
                                    <TableRow key={userTicket.id}>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.id}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.title}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.departmentId}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.status}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.priority}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.type}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>{userTicket.issuerId}</TableCell>
                                        <TableCell align="center" style={{ borderLeft: 'none', borderRight: 'none' }}>
                                            {new Date(userTicket.submittedDate).toLocaleDateString('en-US')}
